    ...
    <section className="py-24 px-6 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="relative">
          <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-cyan-400 via-purple-500 to-green-400" />
            ...
            {timeline.map((item) => {
              ...
              return (
                <div key={item.id} className="relative pl-20">
                  <div className={`absolute left-5 top-6 w-6 h-6 ${colors.dot} rounded-full border-4 border-[#0f1629] animate-pulse`} />

                  <div
                    className={`group ${colors.bg} ${colors.border} border-2 rounded-lg p-6 hover:shadow-lg hover:shadow-current/10 transition-all duration-300 hover:translate-x-2`}
                  >
